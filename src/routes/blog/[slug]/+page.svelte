...
<Template>
	...
	<p style:max-width="800px" style:margin="1em 0 5em">
		<a href="/contact/me/" style:float="left" style:margin="0.15em 1em 0.15em 0"
			><img src="/images/me_umbrella.jpg" alt="Jesse Skinner" class="me" width="140" /></a
		>
		Hi, I'm <a href="/contact/me/">Jesse Skinner</a>. I work with development teams to speed up and
		stabilize web applications, reduce server costs, fix difficult bugs, modernize legacy
		applications, and improve developer productivity.
		<a href="/contact/me/">I'd love to hear from you</a> and see how I can make your life easier.
	</p>
